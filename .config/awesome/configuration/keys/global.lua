...
awful.key({modkey}, 'g', function() _G.awesome.spawn(apps.default.rofi_games) end,
          {description = 'show rofi game menu', group = 'awesome'}),
awful.key({modkey}, 'j', function() awful.client.focus.bydirection('down') end,
          {description = 'Change focus down', group = 'client'}),
awful.key({modkey}, 'k', function() awful.client.focus.bydirection('up') end,
          {description = 'Change focus up', group = 'client'}),
awful.key({modkey}, 'h', function() awful.client.focus.bydirection('left') end,
          {description = 'Change focus left', group = 'client'}),
awful.key({modkey}, 'l', function() awful.client.focus.bydirection('right') end,
          {description = 'Change focus right', group = 'client'}),
awful.key({modkey, 'Shift'}, 'j', function() awful.client.swap.bydirection('down') end,
          {description = 'Change swap down', group = 'client'}),
awful.key({modkey, 'Shift'}, 'k', function() awful.client.swap.bydirection('up') end,
          {description = 'Change swap up', group = 'client'}),
